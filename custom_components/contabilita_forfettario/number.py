...
async def async_setup_entry(
    ...
    entities = [
        ContabilitaNumber(
            "anno_inizio_attivita_pi",
            "Anno Inizio Attività PI",
            2000,
            2100,
            1,
            None,
        ...
        ContabilitaNumber(
            "coefficiente_redditivita_pi",
            "Coefficiente Redditività PI",
            0,
            1,
            0.01,
            None,
        ...
        ContabilitaNumber(
            "contributi_inps_anno_precedente_pi",
            "Contributi INPS Anno Precedente PI",
            0,
            100000,
            1,
            "€",
        ...
        ContabilitaNumber(
            "imposta_netta_anno_precedente_pi",
            "Imposta Netta Anno Precedente PI",
            0,
            50000,
            10,
            "€",
